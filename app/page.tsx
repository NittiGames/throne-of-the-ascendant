...
export default function Page() {
  ...
  const [selectedTradition, setSelectedTradition] = useState(null); // NEW: State for Lore Modal
  ...
  const renderTraditionLore = (name) => {
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-gradient-to-b from-red-950/20 to-black border border-red-900/30 rounded-2xl p-8 relative overflow-hidden group">
                ...
                <p className="text-sm mb-4 text-zinc-400">
                  The ultimate test for any Pyric master is confronting the twisted, god-like entities of their own element. The lesser Dominators, Galaath and Sofaldart, are devastating forces of nature, but the true nightmare of the realm is <strong className="text-white">Aspholghert</strong>.
                </p>
                <p className="text-sm text-zinc-400">
              ...
              <div className="bg-zinc-900/20 border border-white/5 rounded-2xl p-8">
                ...
                <p className="text-sm mb-6 text-zinc-400">To equip these masters, the vaults of the world hold artifacts that reflect this deadly elegance:</p>
                <ul className="space-y-6">
                  <li className="relative pl-4 border-l border-yellow-500/30">
                    <strong className="text-yellow-400 block mb-1 text-sm tracking-wide uppercase">The Silver Ignis</strong>
                    <p className="text-sm text-zinc-400">A minimalist longsword devoid of a crossguard, featuring a sleek obsidian hilt. It does not burst into ostentatious, roaring flames. Instead, the silver blade hums softly, heating to a microscopic, white-hot degree that allows it to slide through iron and bone as if they were silk.</p>
                  </li>
                  <li className="relative pl-4 border-l border-yellow-500/30">
                    <strong className="text-yellow-400 block mb-1 text-sm tracking-wide uppercase">Mantle of the White Ember</strong>
                    <p className="text-sm text-zinc-400">A dark, flowing cloak woven from the conceptual threads of absolute combustion. It protects its wearer not with physical weight or armor plating, but by instantly converting the kinetic energy of any incoming physical strike into a harmless, dissipating flash of heat.</p>
                  </li>
                </ul>
              </div>
            </div>
    ...
    // PLACEHOLDER FOR TRADITIONS WITHOUT TEXT YET
    return (
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden font-sans select-none relative">
      ...
      {/* SHADER STYLES OMITTED FOR BREVITY, KEPT THE SAME AS PREVIOUS */}
      ...
      {/* HERO CAROUSEL OMITTED FOR BREVITY, KEPT THE SAME */}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {TRADITIONS.map((name) => {
              ...
              return (
                <div 
                  key={name}
                  onClick={() => setSelectedTradition(name)} // Trigger Modal
      ...
      <AnimatePresence>
        {selectedTradition && (
          <motion.div
            ...
            onClick={() => setSelectedTradition(null)} // Close on backdrop click
          >
            <motion.div
              ...
              className="relative w-full max-w-6xl max-h-full bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-y-auto shadow-2xl shadow-black [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
            ...
            >
              ...
              <div className="sticky top-0 right-0 w-full flex justify-end p-6 z-10 pointer-events-none">
                <button 
                  ...
                  className="pointer-events-auto bg-black/60 hover:bg-yellow-500 border border-white/10 hover:border-yellow-400 text-zinc-400 hover:text-black rounded-full p-3 transition-all backdrop-blur-md group"
                >
              ...
              <div className="px-8 pb-12 md:px-16 md:pb-16 -mt-12">
